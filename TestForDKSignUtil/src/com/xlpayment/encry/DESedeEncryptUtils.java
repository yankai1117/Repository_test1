...
public class DESedeEncryptUtils {
	...
	private static final String DEFAULT_ENCODING = "UTF-8";
	  ...
	  public static String decrypt(String strKey, String strIn)
	    throws Exception
	  {
	    byte[] bKey = hex2byte(strKey.getBytes("GBK"));
	    SecretKeySpec key = new SecretKeySpec(bKey, "DESede");
	    Cipher decryptCipher = Cipher.getInstance("DESede/ECB/NoPadding");
	    decryptCipher.init(2, key);
	    return new String(decryptCipher.doFinal(hex2byte(strIn.getBytes())), "GBK").trim();
	  }
	  ...
	  public static void main(String[] args)
	  {
	    try
	    {
	      String test = "6225885417311792";
	      System.out.println("test--->"+test);

	      String stren = encrypt("D543CB3EB6ADA879A8D5260E79976183AD3B915DFEADFD16", test);
	      System.out.println("test加密后--->"+stren);
	      String strde = decrypt("D543CB3EB6ADA879A8D5260E79976183AD3B915DFEADFD16", "B75BE419CD0423D51AD0524D5A510778");
